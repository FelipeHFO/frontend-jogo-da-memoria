  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="w-3/4 h-10 bg-transparent text-white border-b mb-5 pl-2 outline-none placeholder:text-white"
      ...
      {isLoading ? (
        <button
          type="submit"
          className="flex justify-center items-center w-3/4 h-10 text-lg font-bold text-white bg-blue-700 m-5 hover:bg-blue-900 transition-all duration-300"
        >
          <svg
            role="status"
